...
public class SoccerNewsRepository {
    ...
    //region Constantes
    private static final String REMOTE_API_URL = "https://thaleshs.github.io/dio-soccer-news-api/";
    ...
    //region Singleton: garante uma instância única dos atributos relacioandos ao Retrofit e Room.
